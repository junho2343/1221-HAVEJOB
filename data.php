<?php
	...
	foreach($object->jobs->job as $data){
        ...
        $company = $company[0];
		$temp[$count]= array("id"=>"".$data->id."","cnt"=>"".$count."","location"=>"".$lo."","url"=>"".$data->url."","total" => "".$total."","company"=> "".$company."","title"=>"". $data->position->title."","experience"=>"".$data->position->$experience."","education"=>"".$data->position->$education."","jtype"=>"".$data->position->$jtype."","category"=>"".$data->position->$category."");
		$count++;
	}
